  ...
  <div class="flex items-center justify-between p-6 md:justify-start md:space-x-10">
    <div>
      <a href="#" class="flex">
        ...
        <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=600" alt="">
      </a>
    </div>
      ...
      <nav class="flex space-x-10">
        <div class="relative">
          ...
          <button type="button" class="group inline-flex items-center rounded-md bg-white text-base font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" aria-expanded="false">
            ...
            <svg class="ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          -->
          <div class="absolute z-10 -ml-4 mt-3 w-screen max-w-md transform lg:max-w-3xl">
