...
<div class="bg-white">
    <main>
      ...
      <div class="overflow-hidden pt-8 sm:pt-12 lg:relative lg:py-48">
        <div class="mx-auto max-w-md px-6 sm:max-w-3xl lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-24 lg:px-8">
          <div>
            <div>
              <img class="h-11 w-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=rose&shade=500" alt="Your Company">
            </div>
            <div class="mt-20">
              <div>
        ...
        <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
          <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <div class="hidden sm:block">
              ...
              <svg class="absolute right-1/2 top-8 -mr-3 lg:left-0 lg:m-0" width="404" height="392" fill="none" viewBox="0 0 404 392">
                <defs>
            ...
            <div class="relative -mr-40 pl-6 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
              <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="https://tailwindui.com/plus/img/component-images/task-app-rose.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
          <div class="relative sm:py-16 lg:py-0">
            <div aria-hidden="true" class="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
              ...
              <svg class="absolute left-1/2 top-8 -ml-3 lg:-right-8 lg:left-auto lg:top-12" width="404" height="392" fill="none" viewBox="0 0 404 392">
                <defs>
            ...
            <div class="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-none lg:px-0 lg:py-20">
              ...
              <div class="relative overflow-hidden rounded-2xl pb-10 pt-64 shadow-xl">
                ...
                <div class="relative px-8">
                  <div>
                    <img class="h-12" src="https://tailwindui.com/plus/img/logos/workcation.svg?color=white" alt="Workcation">
                  </div>
                  <blockquote class="mt-8">
                    <div class="relative text-lg font-medium text-white md:flex-grow">
                      <svg class="absolute left-0 top-0 h-8 w-8 -translate-x-3 -translate-y-2 transform text-rose-400" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
        ...
        <div class="mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-7xl lg:px-8">
          <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-24">
            ...
            <div class="mt-12 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
              <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-8">
                <img class="max-h-12" src="https://tailwindui.com/plus/img/logos/transistor-logo-gray-400.svg" alt="Transistor">
              </div>
              <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-8">
                <img class="max-h-12" src="https://tailwindui.com/plus/img/logos/mirage-logo-gray-400.svg" alt="Mirage">
              </div>
              <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-8">
                <img class="max-h-12" src="https://tailwindui.com/plus/img/logos/tuple-logo-gray-400.svg" alt="Tuple">
              </div>
              <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-8">
                <img class="max-h-12" src="https://tailwindui.com/plus/img/logos/laravel-logo-gray-400.svg" alt="Laravel">
              </div>
              <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-8">
                <img class="max-h-12" src="https://tailwindui.com/plus/img/logos/statickit-logo-gray-400.svg" alt="StaticKit">
              </div>
              <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-8">
                <img class="max-h-12" src="https://tailwindui.com/plus/img/logos/workcation-logo-gray-400.svg" alt="Workcation">
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="mt-24 bg-gray-900 sm:mt-12">
      <div class="mx-auto max-w-md overflow-hidden px-6 py-12 sm:max-w-3xl lg:max-w-7xl lg:px-8">
