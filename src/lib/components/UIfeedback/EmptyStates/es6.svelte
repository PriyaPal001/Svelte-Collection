    ...
    <div>
      ...
      <form class="mt-6 sm:flex sm:items-center" action="#">
        ...
        <div class="grid grid-cols-1 sm:flex-auto">
          <input type="text" name="emails" id="emails" class="peer relative col-start-1 row-start-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6" placeholder="Enter an email">
          ...
          <div class="col-start-2 row-start-1 flex items-center">
            ...
            <select id="role" name="role" class="rounded-md border-0 bg-transparent py-1.5 pl-4 pr-7 text-gray-900 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
