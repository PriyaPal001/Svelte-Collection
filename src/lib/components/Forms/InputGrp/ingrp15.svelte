      ...
      <div class="mt-2 -space-y-px rounded-md bg-white shadow-sm">
        ...
        <div class="flex -space-x-px">
          ...
          <div class="min-w-0 flex-1">
            ...
            <input type="text" name="card-cvc" id="card-cvc" class="relative block w-full rounded-none rounded-br-md border-0 bg-transparent py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" placeholder="CVC">
          </div>
        </div>
      </div>
    </fieldset>
    <fieldset class="mt-6 bg-white">
      ...
      <div class="mt-2 -space-y-px rounded-md shadow-sm">
        <div>
          ...
          <select id="country" name="country" autocomplete="country-name" class="relative block w-full rounded-none rounded-t-md border-0 bg-transparent py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
