    ...
    <div class="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
      ...
      <div class="border-t border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
        ...
        <form class="mt-4 sm:flex sm:max-w-md lg:mt-0">
          ...
          <input type="email" name="email-address" id="email-address" autocomplete="email" required class="w-full min-w-0 appearance-none rounded-md border border-gray-300 bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 focus:border-indigo-500 focus:placeholder-gray-400 focus:outline-none focus:ring-indigo-500 sm:max-w-xs" placeholder="Enter your email">
