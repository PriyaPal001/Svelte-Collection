                ...
                <table class="relative w-full border-separate border-spacing-x-8">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="relative w-1/4 px-4 py-0 text-center">
                        <span class="relative h-full w-full py-3">
                          <span class="text-sm font-semibold leading-6 text-indigo-600">Unlimited accounts</span>
                        </span>
                      </td>
                      <td class="relative w-1/4 px-4 py-0 text-center">
                        <span class="relative h-full w-full py-3">
                    ...
                    <tr>
                      ...
                      <td class="relative w-1/4 px-4 py-0 text-center">
                        <span class="relative h-full w-full py-3">
                          <span class="text-sm font-semibold leading-6 text-indigo-600">Unlimited invoices</span>
                        </span>
                      </td>
                      <td class="relative w-1/4 px-4 py-0 text-center">
                        <span class="relative h-full w-full py-3">
