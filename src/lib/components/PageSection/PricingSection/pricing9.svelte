    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
        <section class="p-8">
          ...
          <a href="#" aria-describedby="tier-basic" class="mt-8 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
        ...
        <section class="rounded-xl bg-gray-400/5 p-8 ring-1 ring-inset ring-gray-200">
          ...
          <a href="#" aria-describedby="tier-essential" class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold leading-6 text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
          <ul role="list" class="mt-10 space-y-4 text-sm leading-6 text-gray-900">
            <li>
              <ul role="list" class="space-y-4">
                <li class="flex gap-x-3">
        ...
        <section class="p-8">
          ...
          <a href="#" aria-describedby="tier-premium" class="mt-8 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
          <ul role="list" class="mt-10 space-y-4 text-sm leading-6 text-gray-900">
            <li>
              <ul role="list" class="space-y-4">
                <li class="flex gap-x-3">
            ...
            <tbody>
              <tr>
                ...
                <td class="px-6 pt-2 xl:px-8">
                  ...
                  <a href="#" class="mt-8 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
                </td>
                <td class="px-6 pt-2 xl:px-8">
                  <div class="flex items-baseline gap-x-1 text-gray-900">
                    <span class="text-4xl font-bold">$29</span>
                  ...
                  <a href="#" class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold leading-6 text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buy plan</a>
                </td>
                <td class="px-6 pt-2 xl:px-8">
                  <div class="flex items-baseline gap-x-1 text-gray-900">
                    <span class="text-4xl font-bold">$59</span>
              ...
              <tr>
                <th scope="colgroup" colspan="4" class="pb-4 pt-8 text-sm font-semibold leading-6 text-gray-900">
                  Features
              ...
              <tr>
                <th scope="colgroup" colspan="4" class="pb-4 pt-16 text-sm font-semibold leading-6 text-gray-900">
                  Reporting
                  <div class="absolute inset-x-8 mt-4 h-px bg-gray-900/10"></div>
                </th>
              </tr>
